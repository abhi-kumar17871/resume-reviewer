        ...
        >
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
                ...
                <div className="p-4 border-t mt-auto flex justify-end gap-3">
                    <button onClick={onClose} className="px-4 py-2 text-sm font-medium rounded-md border hover:bg-gray-100">
                        Cancel
                    </button>
                    <button
                        onClick={handleUpload}
                        disabled={!file || uploading}
                        className="px-4 py-2 text-sm font-medium text-black hover:text-white disabled:hover:text-black bg-gray-400 hover:bg-gray-700 rounded-md disabled:bg-gray-200 disabled:cursor-not-allowed flex items-center gap-2"
                    >
